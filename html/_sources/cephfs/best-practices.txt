...
然而，为稳定起见，你最好别增大 ``max_mds`` ，因为这会让多个守\
护进程同时处于活跃状态。
...
fuse 客户端最容易与服务器做到代码级的同步，但是内核客户端的性\
能通常更好。
...
如果你觉得自己发现了一个缺陷，请在 http://tracker.ceph.com 提\
交。一般问题的话可以在 ceph-users 邮件列表询问。
